...
for (; ; )
{
	...
	{
		ConsoleKey.D1 or ConsoleKey.NumPad1 => () => RunSample<NewExpressionsSample>(),
		ConsoleKey.D2 or ConsoleKey.NumPad2 => () => RunSample<NullCoalescenceExpressionsSample>(),
		ConsoleKey.D3 or ConsoleKey.NumPad3 => () => RunSample<RelationalPatternsSample>(),
		ConsoleKey.D4 or ConsoleKey.NumPad4 => () => RunSample<LogicalPatternsAndSample>(),
		ConsoleKey.D5 or ConsoleKey.NumPad5 => () => RunSample<LogicalPatternsOrSample>(),
		ConsoleKey.D6 or ConsoleKey.NumPad6 => () => RunSample<LogicalPatternsNotSample>(),
		ConsoleKey.D7 or ConsoleKey.NumPad7 => () => RunSample<LogicalPatternsSimpleTypeSample>(),
		ConsoleKey.D8 or ConsoleKey.NumPad8 => () => RunSample<SyntaxTreesGeneratorSample>(),
